...
The vending machine will accept valid coins (Rs.1, 2, 5) and reject invalid ones (any other coins).  When a
...
There are three products: cola for Rs.100.00, chips for Rs.50.00, and candy for Rs.65.00.  When the respective button is pressed
and enough money has been inserted, the product is dispensed and the machine displays THANK YOU.  If the display is
checked again, it will display INSERT COIN and the current amount will be set to Rs.0.00.  If there is not enough money
